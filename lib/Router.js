...
Router.route('/details/:id', {
    ...
    waitOn : function () {        
        ...
        //console.log('SELECTION DES ATTRIBUTS DE '+this.params.id);
        return [TAPi18n.subscribe("products",-1),Meteor.subscribe("attribute",-1),TAPi18n.subscribe("parent_tags"),TAPi18n.subscribe("tags"),TAPi18n.subscribe("parentattr"),Meteor.subscribe("contents")];
...
Router.route('/stock',{
    ...
    waitOn : function () {
        ...
        var skipNum = num * 20;
        return [Meteor.subscribe("stock",skipNum)];
    }
});
