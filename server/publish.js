...
TAPi18n.publish('productsHome', function (limit){ 
    if(limit!=-1)
        return products.i18nFind({},{limit:limit,fields:{_id:1,title:1,image:1}});//return products.find({},{limit:limit});
    else
        return products.i18nFind({},{fields:{_id:1,title:1,image:1}});
});
TAPi18n.publish('productsCategory', function (limit){ 
    if(limit!=-1)
        return products.i18nFind({},{limit:limit,fields:{_id:1,category:1,description:1,image:1,price:1,title:1}});//return products.find({},{limit:limit});
    else
        return products.i18nFind({},{fields:{_id:1,category:1,description:1,image:1,price:1,title:1}});
});
...
Meteor.publish('stock',function(skip){
